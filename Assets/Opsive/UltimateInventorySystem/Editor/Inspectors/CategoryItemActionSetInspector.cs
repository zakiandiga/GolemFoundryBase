...
namespace Opsive.UltimateInventorySystem.Editor.Inspectors
{
    ...
    public class CategoryItemActionSetInspector : InspectorBase
    {
        ...
        protected override List<string> PropertiesToExclude => new List<string>() { c_CategoriesItemActions };
        ...
        protected NestedScriptableObjectInspector<ItemActionSet, CategoryItemActionsInspector> m_SelectedCategoryItemActions;
        ...
        protected override void CreateInspector(VisualElement container)
        {
            ...
            m_ReorderableList = new ReorderableList(
                ...
                () =>
                {
                    ...
                    Shared.Editor.Utility.InspectorUtility.SetDirty(m_CategoryItemActionSet);
                }, (index) =>
                {
            ...
            m_SelectedCategoryItemActions = new NestedScriptableObjectInspector<ItemActionSet, CategoryItemActionsInspector>(
                (createObject) =>
                {
