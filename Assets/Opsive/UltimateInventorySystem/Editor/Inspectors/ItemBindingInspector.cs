...
namespace Opsive.UltimateInventorySystem.Editor.Inspectors
{
    ...
    public class ItemBindingInspector : DatabaseInspectorBase
    {
        ...
        protected void Refresh()
        {
            ...
            m_ItemCategoryAttributeBindingView = new ItemCategoryAttributeBindingView(m_DatabaseField.value as InventorySystemDatabase);
        ...
        private void Serialize()
        {
            ...
            Shared.Editor.Utility.InspectorUtility.SetDirty(m_ItemBinding);
        }
    }
}