...
namespace Opsive.UltimateInventorySystem.Editor.Inspectors
{
    ...
    public class InventoryInspector : DatabaseInspectorBase
    {
        ...
        protected override List<string> PropertiesToExclude => new List<string>() { c_ItemCollectionData, c_ItemCollections };
        ...
        protected override void CreateInspector(VisualElement container)
        {
            ...
            m_ItemCollectionsReorderableList = new ReorderableList(
                ...
                }, (parent, index) =>
                {
                    ...
                    listElement.SetElement(m_ItemCollectionsReorderableList.ItemsSource[index] as ItemCollection, index);
                }, (parent) =>
                {
                ...
                (index) =>
                {
                    var itemCollection = m_ItemCollectionsReorderableList.ItemsSource[index] as ItemCollection;
                    Refresh(itemCollection);
                }, () =>
                {
                    ...
                    Serialize();
                    m_ItemCollectionsReorderableList.Refresh();
                    Refresh(newItemCollection);
                }, (index) =>
                {
        ...
        protected void Refresh(ItemCollection itemCollection)
        {
            ...
            {
                var selectedIndex = m_ItemCollectionsReorderableList.SelectedIndex;
                m_ItemCollectionsReorderableList.ItemsSource[selectedIndex] = newValue;
