...
namespace Opsive.UltimateInventorySystem.Core.InventoryCollections
{
    ...
    public class ItemCollection
    {
        ...
        public ItemCollectionPurpose Purpose {
            get => m_Purpose;
            internal set => m_Purpose = value;
        }

        internal ItemAmounts DefaultLoadout {
            get => m_DefaultLoadout;
        ...
        /// </summary>
        protected virtual void LoadDefaultLoadout()
        {
        ...
        public virtual ItemInfo? AddItemCondition(ItemInfo itemInfo)
        {
            ...
            var newItemInfo = m_Inventory != null ? m_Inventory.AddCondition(itemInfo, this) : itemInfo;
        ...
        public virtual ItemInfo AddItem(ItemInfo itemInfo, ItemStack stackTarget = null)
        {
            ...
            if (!item.IsUnique || amount <= 1) { return AddInternal((item, amount, itemInfo), stackTarget); }
        ...
        public virtual ItemInfo? RemoveItemCondition(ItemInfo itemInfo)
        {
            ...
            var result = m_Inventory != null ? m_Inventory.RemoveCondition(itemInfo) : itemInfo;
