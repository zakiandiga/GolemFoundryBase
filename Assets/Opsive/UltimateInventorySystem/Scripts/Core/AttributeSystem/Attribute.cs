...
namespace Opsive.UltimateInventorySystem.Core.AttributeSystem
{
    ...
    public class Attribute<T> : AttributeBase//, IEquatable<Attribute<T>>
    {
        ...
        protected AttributeBinding<T> m_Binding;
        ...
        {
            var duplicateAttribute = Activator.CreateInstance(GetType(),
        ...
        {
            m_OverrideValue = (T)overrideValue;
        }
        ...
        {
            SetOverrideValue((T)overrideValue, setVariantTypeToOverride, reevaluate);
        }
        ...
        public override void Unbind()
        {
            ...
            if (GetValue().Equals(bindingValue)) { return; }
        ...
        public virtual T ReevaluateReturnValue(bool setAsPreEvaluated)
        {
            ...
            m_PreEvaluatedValue = GetVariantValue();
