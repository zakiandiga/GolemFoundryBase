    ...
    public class ItemBinding : MonoBehaviour, IDatabaseSwitcher
    {
        ...
        public virtual void SetItemObject(ItemObject itemObject)
        {
            if (m_ItemObject != null) {
                EventHandler.UnregisterEvent(m_ItemObject, EventNames.c_ItemObject_OnItemChanged, () => SetItem(m_ItemObject.Item));
                return;
            }
            ...
            EventHandler.RegisterEvent(m_ItemObject, EventNames.c_ItemObject_OnItemChanged, () => SetItem(m_ItemObject.Item));
        ...
        private void SetItem(Item item)
        {
            ...
            //if (m_Item != null) { m_Item.ItemAttributeCollection.OnAttributeChanged -= ItemAttributeValueChanged; }
            ...
            //m_Item.ItemAttributeCollection.OnAttributeChanged += ItemAttributeValueChanged;
