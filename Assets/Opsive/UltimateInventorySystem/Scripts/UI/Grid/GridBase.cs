...
namespace Opsive.UltimateInventorySystem.UI.Grid
{
    ...
    public abstract class GridBase : MonoBehaviour
    {
        ...
        public virtual void Initialize(bool force)
        {
            ...
            m_GridEventSystem.OnGridElementClickE += BoxClicked;
            m_GridEventSystem.OnGridElementSelectedE += BoxSelected;
            m_GridEventSystem.OnGridElementPointerDownE += BoxOnPointerDown;
            m_GridEventSystem.OnGridElementBeginDragE += BoxBeginDrag;
            m_GridEventSystem.OnGridElementEndDragE += BoxEndDrag;
            m_GridEventSystem.OnGridElementDragE += BoxDrag;
            m_GridEventSystem.OnGridElementDropE += BoxDrop;
        ...
        protected abstract void BoxSelected(int index);

        /// <summary>
        /// Click a box.
        /// </summary>
        /// <param name="index">The index.</param>
        protected abstract void BoxClicked(int index);

        protected abstract void BoxOnPointerDown(int index, PointerEventData eventData);

        protected abstract void BoxBeginDrag(int index, PointerEventData eventData);

        protected abstract void BoxEndDrag(int index, PointerEventData eventData);

        protected abstract void BoxDrag(int index, PointerEventData eventData);

        protected abstract void BoxDrop(int index, PointerEventData eventData);
