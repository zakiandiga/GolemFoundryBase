    ...
    public class ItemDropper : Dropper
    {
        ...
        protected virtual void Awake()
        {
            if (m_PickUpPrefab == null) {
                Debug.LogError("The PickUp Prefab is null, a Prefab with the scripts Item Pickup or Inventory Pickup must be specified.");
                return;
            }
        ...
        /// </summary>
        /// <param name="itemList">The item collection to drop.</param>
        protected virtual void DropInventoryPickup(ListSlice<ItemInfo> itemList)
        {
        ...
        protected virtual void DropItemPickup(ItemInfo itemInfo)
        {
