...
namespace Opsive.UltimateInventorySystem.UI.Item.DragAndDrop.DropActions
{
    ...
    /// </summary>
    [Serializable]
    public class ItemViewDropContainerCanSmartExchangeConditioncustom : ItemViewDropCondition
    {
    ...
    /// </summary>
    [Serializable]
    public class ItemViewDropContainerSmartExchangeActionCustom : ItemViewDropAction
    {
        ...
        /// Default constructor.
        /// </summary>
        public ItemViewDropContainerSmartExchangeActionCustom()
        {
        }
